-- ORDERS SCREEN SUPABASE SQL - Simple Version
...
CREATE TABLE IF NOT EXISTS public.shipping_addresses (
  ...
  user_id UUID NOT NULL, -- Will reference profiles table when it exists
  name TEXT NOT NULL,
  phone TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS public.orders (
  ...
  buyer_id UUID NOT NULL, -- Will reference profiles table when it exists
  seller_id UUID NOT NULL, -- Will reference profiles table when it exists
...
CREATE TABLE IF NOT EXISTS public.order_items (
  ...
  product_id UUID NOT NULL, -- Will reference products table when it exists
...
CREATE TABLE IF NOT EXISTS public.chats (
  ...
  user_id UUID NOT NULL, -- Will reference profiles table when it exists
  vendor_id UUID NOT NULL, -- Will reference profiles table when it exists
  order_id UUID REFERENCES public.orders(id),
  title TEXT,
  last_message TEXT,
...
CREATE TABLE IF NOT EXISTS public.messages (
  ...
  sender_id UUID NOT NULL, -- Will reference profiles table when it exists
