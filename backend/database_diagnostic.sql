-- DATABASE DIAGNOSTIC SCRIPT FOR MITHAS GLOW
...
-- SAMPLE DATA CHECK
-- =====================================================
SELECT 'PROFILES SAMPLE' as info, id, email, user_type, profile_completed, created_at
FROM profiles 
LIMIT 3;

SELECT 'SHOPS SAMPLE' as info, id, user_id, shop_name, created_at
FROM shops 
LIMIT 3;
