...
DROP POLICY IF EXISTS "Pro users can upload product images" ON storage.objects;
DROP POLICY IF EXISTS "Pro users can update own product images" ON storage.objects;
DROP POLICY IF EXISTS "Pro users can delete own product images" ON storage.objects;
